            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group mb-4">
                        <label class="form-label">Category Icon (Menu/Landing)</label>
                        <div class="current-image mb-3">
                            <img src="{{ $category->image_url }}" alt="Current category icon" id="currentCategoryImage" class="img-fluid" style="max-height: 150px;">
                        </div>
                        ...
                        <div class="image-upload" onclick="document.getElementById('categoryImage').click()">
                            ...
                            <input type="file" name="image" id="categoryImage" class="file-input" accept="image/*" onchange="previewImage(this, 'imagePreview')">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-image mb-3">
                            <img src="{{ $category->background_image_url }}" alt="Current background" class="img-fluid" style="max-height: 150px;">
                        </div>
                        @endif
